...
import {
  Package, Truck, CheckCircle2, Clock, Calendar, MapPin,
  ExternalLink, AlertCircle, Loader2, Shield,
} from "lucide-react";

/* ── Types (subset exposed by the public API) ── */
...
const PROGRESS_STEPS = ["quote", "approved", "in_production", "shipped", "delivered"] as const;
...
export default function CustomerPortalPage() {
  ...
  if (error || !data) {
    ...
    const isExpired = msg.includes("expired") || msg.includes("deactivated");
  ...
  const statusInfo = STATUS_MAP[order.status] || STATUS_MAP.quote;
