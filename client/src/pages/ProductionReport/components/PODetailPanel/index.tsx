        ...
        <SheetContent className="w-[600px] sm:max-w-[600px] overflow-y-auto py-12">
          {isLoading ? (
            ...
            <>
              ...
              <SheetDescription className="text-sm text-muted-foreground">
                The requested PO could not be found.
              </SheetDescription>
            </>
          ) : (
            <>
              <SheetHeader className="pb-4 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <SheetDescription className="text-sm hidden">
                    PO Details & Quick Actions
                  </SheetDescription>
                  ...
                  <div className="flex items-center gap-1 mb-1">
                    {productionStages.map((stage: any, idx: number) => (
                      <div
                        ...
                        key={stage.id}
                        className={`h-1.5 flex-1 rounded-full transition-colors ${idx < currentStageOrder
                          ? "bg-primary"
