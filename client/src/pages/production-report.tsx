...
interface ProductionOrder {
  ...
  assignedUser?: any; // Full user object for avatar display
  csrUser?: any; // Full CSR user object for avatar display
...
export default function ProductionReport() {
  ...
  const [newStage, setNewStage] = useState({ name: '', description: '', color: 'bg-gray-100 text-gray-800', icon: 'Package' });
  ...
  const handleAddStage = async () => {
    ...
    try {
      ...
      setNewStage({ name: '', description: '', color: 'bg-gray-100 text-gray-800', icon: 'Package' });
      toast({
        title: "Stage Added",
                    ...
                    return (
                      <React.Fragment key={order.id}>
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <UserAvatar user={order.assignedUser} size="sm" />
                          ...
                          <div className="grid grid-cols-2">
                            ...
                            <div className="flex gap-2 items-center">
                              <UserAvatar
                                ...
                                size="sm"
                              />
                              <span className="text-sm text-gray-700">{order.assignedTo || 'Unassigned'}</span>
                            </div>
                          </div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <UserAvatar
                          user={selectedOrder.assignedUser}
                          size="sm"
                        />
