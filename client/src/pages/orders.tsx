...
import { Calendar, DollarSign, FileText, Kanban, List, PlusCircle } from "lucide-react";
    ...
    <div className="space-y-6 p-6 pb-6">
      ...
      {isLoading ? (
        ...
        <DataTable
          ...
          meta={{
            onViewOrder: (order: Order) => setLocation(`/orders/${order.id}`),
        ...
        <KanbanBoard
          data={ordersWithRelations}
          onViewOrder={(order) => setLocation(`/orders/${order.id}`)}
