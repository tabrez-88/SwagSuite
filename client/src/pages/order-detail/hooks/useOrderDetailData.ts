...
export function useOrderDetailData(orderId: string | null | undefined) {
  ...
  // ── Phase 2: New entity queries ──

  // Fetch line items for each order item
  ...
  // Fetch additional charges for each order item
  ...
  // Fetch portal tokens for the order
