  ...
  return (
    <div className="min-h-screen bg-gray-100" style={{ fontFamily: font }}>
      ...
      <div className="bg-white border-b px-4 py-2 flex items-center gap-3">
        <Button variant="ghost" size="sm" onClick={() => setLocation(`/project/${orderId}/presentation`)}>
...
function ProductDetailLightbox({ item, items, companyName, primaryColor, logoUrl, hidePricing, onClose, onNavigate }: {
  item: any; items: any[]; companyName: string; primaryColor: string; logoUrl: string | null; hidePricing: boolean;
  onClose: () => void; onNavigate: (item: any) => void;
}) {
