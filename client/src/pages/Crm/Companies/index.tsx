                    ...
                    <TableBody>
                      {filteredCompanies.map((company: Company) => (
                        <TableRow
                          ...
                          onClick={() => handleOpenDetailFromList(company)}
          ...
          {selectedCompany && (
            <>
                ...
                <DialogTitle className="flex items-center gap-3">
                  ...
                  {selectedCompany.engagementLevel && (
                    <Badge
                      className={`ml-auto ${
                        ENGAGEMENT_COLORS[
                          selectedCompany.engagementLevel as keyof typeof ENGAGEMENT_COLORS
                        ] || ENGAGEMENT_COLORS.undefined
                      }`}
                    >
                      {selectedCompany.engagementLevel
                        .charAt(0)
                        .toUpperCase() +
                        selectedCompany.engagementLevel.slice(1)}{" "}
                      Engagement
                    </Badge>
                  )}
                </DialogTitle>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <a
                            ...
                            className="text-swag-orange hover:underline"
                          >
                            {selectedCompany.website.replace(
                              /^https?:\/\//,
                              ""
                            )}
                          </a>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold">
                            {selectedCompany.customerScore}/100
                          </p>
                        </div>
                      </div>
                    )}
                ...
                {/* Social Media Links */}
                {selectedCompany.socialMediaLinks &&
                  Object.values(selectedCompany.socialMediaLinks).some(
                    (link) => link
                  ) && (
              ...
              <div className="flex justify-end gap-3 mt-6 pt-6 border-t">
                <Button
                  variant="outline"
                  onClick={() =>
                    handleNavigateToCompany(selectedCompany.id)
                  }
                >
